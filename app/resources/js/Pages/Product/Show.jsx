                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center space-x-3">
                            <span
                                className={`inline-flex px-3 py-1 rounded-full text-sm font-medium ${stockStatus.color}`}
                            >
                                {stockStatus.text}
                            </span>
                                                ...
                                                <div className="flex items-center justify-center space-x-2">
                                                    ...
                                                    >
                                                        <path
                                                            ...
                                                            strokeLinejoin="round"
                                                            strokeWidth={2}
                                                            d="M3 3h2l.4 2M7 13h10l4-8H5.4m2.6 8L6 5H2m5 8l4-4m0 0l4 4m-4-4v12"
                                                        />
                                                    </svg>
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        <ul className="text-gray-700 space-y-1">
                                            ...
                                            <li>
                                                • Express delivery: 1-2 business
                                                days (additional cost applies)
                                            </li>
                                            <li>
