                            ...
                            <div className="flex items-center gap-2 md:gap-3">
                                ...
                                {auth?.user ? (
                                    <div className="flex items-center gap-2">
                                        <span className="text-sm text-gray-700 hidden md:block">Welcome, {auth.user.name}</span>
                                        <Button 
                                            variant="outline" 
                                            size="sm" 
                                            className="text-sm"
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Link href="/register">
                                            <Button size="sm" className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-3 md:px-6 font-medium text-sm">
                                                Register
                                            </Button>
                                        </Link>
                                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <Card
                            className={`cursor-pointer transition-all duration-200 hover:shadow-lg border ${
                                selectedCategory === 'all' ? 'ring-2 ring-blue-500 bg-blue-50 border-blue-200' : 'hover:bg-gray-50 border-gray-200'
                            }`}
                        ...
                        >
                            <CardContent className="p-4 text-center">
                                ...
                                <div className="text-sm font-medium text-gray-900">All Products</div>
                        ...
                        {categories && categories.map((category) => {
                            ...
                            const categoryColors = {
                                'Pakatan Wanita': 'from-pink-500 to-rose-500',
                                'Pakatan Pria': 'from-blue-500 to-indigo-500',
                                'Buku': 'from-green-500 to-emerald-500',
                                'Kecantikan': 'from-purple-500 to-pink-500',
                                'Elektronik': 'from-gray-500 to-slate-500'
                            };
                            ...
                            return (
                                <Card
                                    key={category.id}
                                    className={`cursor-pointer transition-all duration-200 hover:shadow-lg border ${
                                        selectedCategory === category.id.toString() ? 'ring-2 ring-blue-500 bg-blue-50 border-blue-200' : 'hover:bg-gray-50 border-gray-200'
                                    }`}
                                    onClick={() => setSelectedCategory(category.id.toString())}
                                >
                                    <CardContent className="p-4 text-center">
                                        <div className={`w-12 h-12 mx-auto mb-2 bg-gradient-to-r ${categoryColors[category.name] || 'from-gray-500 to-slate-500'} rounded-lg flex items-center justify-center`}>
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                                                            ...
                                                            <div className="absolute top-3 left-3 flex flex-col gap-2">
                                                                ...
                                                                {/* New Arrival Badge */}
                                                                {products && products.length > 0 && product.id > Math.max(...products.map(p => p.id)) - 2 && (
                                                            ...
                                                            <div className="absolute top-3 right-3">
                                                                <Badge className={`text-xs px-2 py-1 ${stockStatus.color}`}>{stockStatus.text}</Badge>
                                                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <p className="text-gray-400 mb-4 leading-relaxed">
                                Your trusted online shopping destination for quality products at great prices. We're committed to providing the best shopping experience.
                            </p>
                        </div>
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <ul className="space-y-2">
                                <li><Button variant="ghost" className="text-gray-400 hover:text-white justify-start p-0">About Us</Button></li>
                                <li><Button variant="ghost" className="text-gray-400 hover:text-white justify-start p-0">Contact Us</Button></li>
                                <li><Button variant="ghost" className="text-gray-400 hover:text-white justify-start p-0">Privacy Policy</Button></li>
                                <li><Button variant="ghost" className="text-gray-400 hover:text-white justify-start p-0">Terms of Service</Button></li>
                            </ul>
                        </div>
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <p className="text-gray-400 mb-4">Stay up to date with our latest offers and new products.</p>
